 ...
 *
 * Disassembly of iASLHkE6Mn.aml, Mon Jul 10 11:22:40 2017
 *
 * Original Table Header:
 *     Signature        "SSDT"
 *     Length           0x00000909 (2313)
 *     Revision         0x01
 *     Checksum         0x4C
 *     OEM ID           "APPLE "
 *     OEM Table ID     "CpuPm"
 *     OEM Revision     0x00021100 (135424)
 *     Compiler ID      "INTL"
 *     Compiler Version 0x20140926 (538183974)
 */
DefinitionBlock ("", "SSDT", 1, "APPLE ", "CpuPm", 0x00021100)
{
    ...
    Scope (\_PR.CPU0)
    {
        ...
        {
            Store ("ssdtPRGen version.....: 21.1 / Mac OS X 10.12.1 (16B2657)", Debug)
            Store ("custom mode...........: 0", Debug)
            Store ("host processor........: Intel(R) Core(TM) i7-6820HK CPU @ 2.70GHz", Debug)
            Store ("target processor......: i7-6820HK", Debug)
